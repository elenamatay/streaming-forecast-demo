...
INPUT = './data/sensors_compressed_2.json.gz'
...
def get_json_object(line):
   ...
   obj_dict = {}
   obj_dict["sensor_id"] = values['sensor_id']
   obj_dict["value"] = values['value']
   obj_dict["ts"] = values['ts']
...
def simulate(topic, ifp, firstObsTime, programStart, speedFactor):
   ...
   for line in ifp:
       ...
       event_data = get_json_object(line)   # entire line of input JSON is the message
